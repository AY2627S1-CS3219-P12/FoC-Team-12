...
Use this explicit workflow to commit ready Friend on Campus changes. Apply the
installed `$commit` skill and these repository-specific decisions; this skill does
not push, amend, rebase, merge, reset, deploy, or bypass hooks.
