...
class UserRepositoryMigrationTest {
 ...
 @Test void flywayCreatesUsersTable() { assertThat(jdbc.queryForObject("SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'USERS'", Integer.class)).isEqualTo(1); }
}
